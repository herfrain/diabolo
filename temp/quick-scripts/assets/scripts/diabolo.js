(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/diabolo.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b1ca5JWsBNNnI2DSNoHAI5O', 'diabolo', __filename);
// scripts/diabolo.js
...
cc.Class({
    ...
    properties: (_properties = {
        ...
        leftNode: null, //左连接点
        rightNode: null, //右连接点
        leftJoint: null }, _defineProperty(_properties, "leftJoint", null), _defineProperty(_properties, "camera", null), _defineProperty(_properties, "popupAudio", {
        default: null,
        type: cc.AudioClip
    }), _defineProperty(_properties, "pullAudio", {
        default: null,
        type: cc.AudioClip
    }), _properties),
...
cc._RF.pop();
        ...
        //# sourceMappingURL=diabolo.js.map
